        ...
        <div class="col-lg-6 offset-3">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- FORM STARTS --}}
                    <form class="p-1 m-1 row" method="POST" action="{{route('updateAdmin')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-4">
                            ...
                            <div class="row w-100 d-flex justify-content-center flex-row">
                                ...
                                <a href="{{route('profile')}}" class="btn btn-secondary rounded col-5 offset-1" >Discard</a>
                            </div>
                        </div>
